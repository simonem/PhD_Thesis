...
The work in this thesis is based on design research [@Hevner:2010fy; @March:1995gm]. Design science provides theoretical tools to study and understand a specific domain and processes to build artefacts with the aim of improving an environment [@simon1996sciences]. The work unfolds by interweaving exploratory studies to understand a specific setting, turning problems and opportunities observed into requirements; and design iterations. The artifact produced are both useful for understanding the domain and in adding new knowledge to the domain.

Design science supports the aim of this research work, which lies not only in building an understanding of the crisis domain but also in contributing with the design of technologies for better crisis training (RQ1-RQ2). The focus of design science on  rapid iterations between the construction of artifacts and their evaluation [@Hevner:2010gc] it makes a good strategy for the investigation of RQ3.

Hevner [-@Havner2004; -@hevner2007three] describes design research as a sequence of three closely related cycles of activities (Figure X). The three cycles must be present and visible in any design science research project [@Hevner:2010gc].
...
The *design cycle* iterates between the production of an artifact, its formative evaluation and derive feedbacks to refine the design further. The cycle is fed with requirements from the relevance cycle and theories and methods from the rigor cycle and returns artefacts for field test to the former and knowledge to the advances of theories to the latter. This cycle is characterised by rapid iterations where small incremental improvement in design artefacts are tested before an artefact is released into the field or new knowledge is added to the rigor cycle. **This stage involves the construction of prototypes and run lab tests**.

To support design research qualitative methods were largely adopted. Observations, interviews and researchers’ notes were the primary means to collect data on the field. Scenarios and personas drove the design phase. Open source hardware and software tools were largely adopted to turn mockups into working prototypes. Finally questionnaires, interviews and descriptive statistics were used during formative and summative evaluations. Quantitate data from technical logs and formal documents about rescue protocols were also employed. 

The choice of these methods required the researchers to have large access to people, knowledge and protocols of organisation working in the crisis domain. This research strategy was facilitated by having crisis response organisation member of the MIRROR consortium. Throughout the duration of the work discussion with members of the MIRROR consortium helped in shaping design choices and partially influenced the work. This activity as been carried on as part of project meetings and workshops.

The following section describes what research activities for each of the three cycle have been performed.
...
During the studies with evaluation purposes, selected workers previously asked for enrolment in the study, were provided with prototypes to test. Workers were walked thru the use of technology by a researcher and a set of task to be accomplished was given to each participant. Tasks had to be performed as part simulated crisis work events, to assess the compatibility for the technology do be employed during the implementation of rescue protocols. Participants’ interaction with the technology was video recorded with wearable cameras, plus prototypes were configured to log modes of operation. After each test researchers followed up with interviews and surveys. Questions asked were selected from the toolbox reported in [@Knipfer:2012vi], which has been specifically developed to run user studies within the MIRROR project. 
...
During exploratory studies attention was on how practitioners capture aspects of their work experience, trying to identifies what information is relevant for reflection and what interaction modalities are suitable for the use in action. The outcome of this analysis produced a set of requirements to drive the design of technology; including challenges, system requirements, scenarios and personas. This results feeds the *design cycle*.

During evaluation studies the focus was on evaluating how well the artifacts perform against usability and for supporting the reflection cycle. Usability metrics \todo{need reference?} and a reflection scale provided by the mirror evaluation toolbox [@Knipfer:2012vi] have been adopted. The outcome of this analysis produces both an addition to the requirements for the technology and knowledge to validate existing theories or to generate new constructs in the *rigor cycle*. 
...
The work followed a *user centred approach* [@MAGUIRE:2001dp; @Gulliksen:2003hd], based on exploratory studies and design work following in multiple iterations. 

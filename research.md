...
Hevner [-@Havner2004; -@hevner2007three] describes design research as a sequence of three closely related cycles of activities (Figure X). Each go the the three cycles must be present and visible in any design science research project [@Hevner:2010gc].
...
The choice of these methods required the researchers to have large access to people, knowledge and protocols of organisation working in the crisis domain. This research strategy was facilitated by having crisis response organisation member of the MIRROR consortium. Moreover, throughout the duration of the work ,discussion with members of the MIRROR consortium helped in shaping design choices and partially influenced the work. This activity as been carried on as part of project meetings and workshops.

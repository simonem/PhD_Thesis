...
\todo[inline]{
Revision 6:\\-research abroad moved in appendix}
...
\textbf{Appendix \ref{toolkites}} includes a benchmark of hardware toolkits for rapid prototyping which has been used to select the specific tools used to implement the prototypes in this PhD. 

...
\begin{quote}
	\emph{\textbf{Contribution 1:} Implementation and evaluation of MIRROR Computer Supported Reflective Learning (CSRL) theory.} It includes a validation of previous theoretical models and the formulation of new constructs. 
\end{quote}
\begin{quote}

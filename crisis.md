...
In this section, I provide a brief introduction to the field of crisis management and preparedness. The two areas are related in that better preparedness to a crisis event is expected to produce better management.
...
ICT can introduce new opportunities to the reflective practice\todo{this is the premise of RQ1}, for example providing sensors for capturing different aspects of experiences, user interfaces facilitate the practitioner in reflecting the information captured and infrastructures to share data and reflection outcomes among practitioners. 

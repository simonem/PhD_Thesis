...
\begin{figure}
	[h!] \centering 
	\includegraphics[width=0.75\textwidth]{3steps} \caption{Three activities required to better deal with a crisis} \label{fig:three-stages} 
\end{figure}
...
\begin{figure}
	[h!] \centering 
	\includegraphics[width=0.9\textwidth]{crisis_timeline} 

\documentclass[10pt,b5paper,twoside,openright,showtrims]{memoir}
...
%  \renewcommand{\printchaptername}{}
  %\renewcommand{\afterchaptertitle}{\chapnumfont\hfill\thechapter\\\vspace*{-.3cm}\hrulefi%ll\vspace*{6cm}\\}
%}
%\makeatother
